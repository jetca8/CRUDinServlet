...
/**
 * delete the record by course code
...
CredentialsDTO creds = new CredentialsDTO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            course.setCourseCode(request.getParameter("deleteCourseCode"));
            out.println("<p> CourseCode " + request.getParameter("deleteCourseCode") +  " is deleted.</p>");
            logic.delete(course);
